...
par(mar = c(6, 4, 4, 4)) 
boxplot(normed_log_counts, xlab = "", 
        ylab = "log2(CPM) values", las = 2,
        cex = 0.5, cex.lab = 0.75, cex.axis = 0.5, 
